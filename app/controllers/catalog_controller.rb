class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("sponsorship", :stored_searchable), label: "Department", itemprop: 'sponsorship', link_to_search: solr_name("sponsorship", :facetable)
    config.add_index_field solr_name("committeemember", :stored_searchable), label: "Committee Member(s)", itemprop: 'committeemember', link_to_search: solr_name("committeemember", :facetable)
    ...
    config.add_show_field solr_name("sponsorship", :stored_searchable), label: "Department"
    config.add_show_field solr_name("committeemember", :stored_searchable), label: "Committee Member(s)"
